...
def main(args):
    ...
    training_args = Seq2SeqTrainingArguments(
        ...
        save_total_limit=2, load_best_model_at_end=True, fp16=True, dataloader_num_workers=4
    )

    trainer = Seq2SeqTrainer(
        model=model.model, args=training_args, train_dataset=train_dataset, 
        eval_dataset=val_dataset, data_collator=VisionEncoderDecoderCollator(),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--decoder_model', type=str, default='microsoft/biogpt', help="Use 'gpt2' or 'microsoft/biogpt'")
