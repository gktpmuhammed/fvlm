...
def main():
    ...
    parser.add_argument('--csv_file', type=str, default='data/image_first_dataset.csv')
    parser.add_argument('--json_file', type=str, default='data/combined_desc_conc_v2.json')
    parser.add_argument('--output_dir', type=str, default='./checkpoints/retrain_v3')
